...
import '../../../commans/widgets/custom_textform_field.dart';
import '../../../commans/widgets/custome_elevated_button.dart';
import '../../../resources/app_colors.dart';
import '../../../utils/managers/user_manager.dart';
import '../../../utils/validator/text_feild_validator.dart';
                ...
                builder: (context, value, child) {
                  return MyCustomTextFormField(
                    ...
                    suffixIcon: IconButton(
                      // Make the suffix icon clickable
                      icon: Icon(
                ...
                builder: (context, value, child) {
                  return MyCustomTextFormField(
                    ...
                    obscureText: _obscureTextNewPass
                        .value, // Controls visibility of text
